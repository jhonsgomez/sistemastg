...
<body>
    <main>
        <div>
            <div>
                <p>Buen día,</p>
                <p>Estimado usuario, en este correo se le recuerda que usted actualmente está vinculado al proyecto titulado <strong class="uppercase">"{{ isset($titulo) ? $titulo : 'No Específicado' }}"</strong>, el cual se encuentra en <strong class="uppercase">{{ $proyecto->estado }}</strong>, y que aún <strong>NO</strong> se ha aprobado el <strong class="uppercase">F-DC-125</strong>:</p>
                <ul>
            ...
            <br>
            <p class="uppercase">Recuerde que este proyecto tiene como fecha máxima de entrega del informe el <strong>{{ $fecha_maxima_informe }}</strong>. Si no se aprueba, una vez superada esta fecha el sistema inhabilitará el proyecto.</p>
            <p><strong>NOTA: </strong>Si desea solicitar <strong>PRÓRROGA</strong> deberá hacerlo antes de la fecha máxima. Si el proyecto ya se encuentra en <strong>FASE FINAL</strong>. Por favor omita el contenido de este correo.</p>
        </div>
