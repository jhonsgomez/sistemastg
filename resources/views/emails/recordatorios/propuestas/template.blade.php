...
<body>
    <main>
        <div>
            <div>
                <p>Buen día,</p>
                <p>Estimado usuario, en este correo se le recuerda que usted actualmente está vinculado al proyecto titulado <strong class="uppercase">"{{ isset($titulo) ? $titulo : 'No Específicado' }}"</strong>, el cual se encuentra en <strong class="uppercase">{{ $proyecto->estado }}</strong>, y que aún <strong>NO</strong> se ha aprobado:</p>
                <ul>
                    <li><strong>Tipo de solicitud:</strong> NUEVO POYECTO DE GRADO {{ $periodo }}</li>
            ...
            <br>
            <p class="uppercase">Recuerde que este proyecto tiene como fecha máxima de aprobación el <strong>{{ $fecha_aprobacion }}</strong>. Si no se aprueba, una vez superada esta fecha el sistema inhabilitará el proyecto.</p>
            <p><strong>NOTA: </strong>Si el proyecto ya se encuentra en <strong>FASE 4</strong> o superior. Por favor omita el contenido de este correo.</p>
        </div>
