...
<body>
    ...
    <ul>
        ...
        @if (!empty($cuerpo['nro_acta']) && !empty($cuerpo['fecha_acta']))
            <li>
                <strong>Acta de registro:</strong>
                #{{ $cuerpo['nro_acta'] }} - {{ $cuerpo['fecha_acta'] }}
            </li>
        @endif
    </ul>
    ...
    @if ($remitente === 'evaluador')
        ...
        @if ($estado === 'Aprobada')
            <p>
                ...
                será el encargado de realizar la revisión final del proceso de prácticas empresariales.
            </p>
        @else
            <p>
                Se recomienda revisar las observaciones del evaluador, corregir los documentos
                correspondientes al informe final y realizar nuevamente el envío en la fase correspondiente.
            </p>
        @endif
    ...
    @else
        ...
        @else
            <p>
                Se recomienda revisar las observaciones del comité. La práctica volverá a la
                <strong>FASE 5</strong> para realizar los ajustes necesarios y efectuar nuevamente el envío.
            </p>
        @endif
